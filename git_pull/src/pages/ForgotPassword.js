...
const ForgotPassword = () => {
    ...
    const handleEmailSubmit = async(e) => {
        ...
        try {
            const response = await fetch('http://localhost/gard_1/makemyveggies-feature-bhavesh_react/mmv/makemyveggies/backend/api/request_password_reset.php', {
                method: 'POST',
                headers: {
    ...
    return ( <
        ...
        {
            message && ( <
                div className = { `alert ${message.includes('success') ? 'alert-success' : 'alert-danger'} mb-3` } > { message } <
                /div>
            )
        }
        ...
        { /* Step 1: Enter Email */ } {
            step === 1 && ( <
                ...
                disabled = { isSubmitting } > { isSubmitting ? 'Sending OTP...' : 'Send OTP' } <
                /button> <
                /div> <
                /form>
            )
        ...
        { /* Step 2: Enter OTP */ } {
            step === 2 && ( <
                ...
                <
                label htmlFor = "otp"
                className = "form-label" > OTP Code < /label> <
                input type = "text"
                ...
                button type = "submit"
                className = "btn btn-primary w-100"
                disabled = { isSubmitting } > { isSubmitting ? 'Verifying...' : 'Verify OTP' } <
                /button> <
                /div>
        ...
        { /* Step 3: Set New Password */ } {
            step === 3 && ( <
                ...
                button type = "submit"
                className = "btn btn-primary w-100"
                disabled = { isSubmitting } > { isSubmitting ? 'Resetting...' : 'Reset Password' } <
                /button> <
                /div>
