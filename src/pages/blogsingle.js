                ...
                <div className="author-box">
                  ...
                  <div className="author-box-content">
                    ...
                    <div className="author-box-social">
                      <button className="social-link" title="Instagram" disabled><i className="fab fa-instagram" /></button>
                      <button className="social-link" title="Facebook" disabled><i className="fab fa-facebook-f" /></button>
                      <button className="social-link" title="Twitter" disabled><i className="fab fa-twitter" /></button>
                      <button className="social-link" title="LinkedIn" disabled><i className="fab fa-linkedin-in" /></button>
                    </div>
                  </div>
                </div>
              </article>
