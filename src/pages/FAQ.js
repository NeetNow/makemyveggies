    ...
    return ( <
        ...
        h4 > What services do you offer ? < /h4> <
            ...
            h4 > How much do your services cost ? < /h4> <
                p > Our pricing varies depending on the scope of work.We provide free consultations and detailed quotes
            for
            all projects.Contact us
        for
        a personalized estimate. < /p> <
        /div> <
        div className = "faq__item" >
        <
        h4 > Do you offer emergency services ? < /h4> <
        p > Yes, we provide emergency tree removal and storm damage cleanup services.Call us anytime
        for urgent landscaping needs. < /p> <
        /div> <
        div className = "faq__item" >
        <
